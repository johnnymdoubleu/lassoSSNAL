...
%%
   ...
   %{
   %DBG
   fprintf('\n  maxiter = %3.2f',parmain.maxiter); %DBGGG
   %fprintf('\n  dscale = %3.2f',parmain.dscale); %DBGGG
   fprintf('\n  Ascaleyes = %3.2f',parmain.Ascaleyes); %DBGGG
   fprintf('\n  m = %3.2f',parmain.m); %DBGGG
   fprintf('\n  n = %3.2f',parmain.n); %DBGGG
   fprintf('\n  scale = %3.2f',parmain.scale); %DBGGG
   fprintf('\n  existA = %3.2f',parmain.existA); %DBGGG
   fprintf('\n  orgojbconst = %3.2f',parmain.orgojbconst); %DBGGG
   fprintf('\n  tstart = %3.2f',parmain.tstart); %DBGGG
   fprintf('\n  Lip = %3.2f',parmain.Lip); %DBGGG
   %fprintf('\n  sigma = %3.2f',parmain.sigma); %DBGGG
   fprintf('\n  printyes = %3.2f',parmain.printyes); %DBGGG
   fprintf('\n  rescale = %3.2f',parmain.rescale); %DBGGG
   fprintf('\n  stoptol = %3.2f',parmain.stoptol); %DBGGG
